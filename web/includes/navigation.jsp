<ul>
    <li><a href="afterLogin.jsp" class="ico"><span class="icon home"></span>Home</a></li>
    <li><a href="UserServlet?action=ListUsers" class="ico"><span class="icon users"></span>Maintain Users</a></li>
